...
NAMFox.translationRules = [
    {
        name: "Edit tags",
        regexp: /(?:<br \/><br \/>)?<div[^>]*?class="small right"[^>]*?>[^<]*?Edit[^<]*?<\/div><br \/><\/div>$/,
        replacement: ""
    },
    {
        name: "Moderation queue messages",
        regexp: /<p> \[ Check <a href=".*?\/index.php\?fn=moderation_queue\&amp;f=\d+">moderation queue<\/a> to see who reported this post \] (?:<\/p>)?\s*$/,
        replacement: ""
    },
    {
        name: "Moderation queue messages (2)",
        regexp: /<p> \[ This message has been moved to the <a href=".*?\/index.php\?fn=moderation_queue\&amp;f=\d+">moderation queue<\/a> and is being shown to you due to your moderator status \] <\/p>\s*$/,
        replacement: ""
    },
    {
        name: "Mail links",
        regexp: /<a href="mailto:(.*?)" target="_blank">\1<\/a>/g,
        replacement: "$1"
    },
    {
        name: "Quote 1",
        regexp: /<blockquote(?: style="color: #222266")?><font size=1>quote <b><a href="\/forums\/directmessage.php\?m=(\d+)" target="_blank">(.*?)<\/a><\/b><br \/><\/font><div class="qt">/g,
        replacement: "[quote=$2|message:$1]"
    },
    {
        name: "Quote 2",
        regexp: /<blockquote(?: style="color: #222266")?><font size=1>quote <b><a href="(.*?)" target="_blank">(.*?)<\/a><\/b><br \/><\/font><div class="qt">/g,
        replacement: "[quote=$2|$1]"
    },
    {
        name: "Quote 3",
        regexp: /<blockquote(?: style="color: #222266")?><font size=1>quote <b><a href="(.*?)" target="_blank">(.*?)<\/b><br \/><\/font><div class="qt"><\/a>/g,
        replacement: "[quote][originator=[link name=$2]]$1[/link]"
    },
    {
        name: "Quote 4",
        regexp: /<blockquote(?: style="color: #222266")?><font size=1>quote <b>(.*?)<\/b><br \/><\/font><div class="qt">/g,
        replacement: "[quote=$1]"
    },
    {
        name: "Quote 5",
        regexp: /<blockquote(?: style="color: #222266")?><font size=1>quote<\/font><div class="qt">/g,
        replacement: "[quote]"
    },
    {
        name: "End Quote",
        regexp: /<\/div><\/blockquote>/g,
        replacement: "[/quote]\n\n"
    },
    {
        name: "Code tag",
    ...
    {
        name: "PHP tag",
        regexp: /<table width="90%"><tr><td><font size=1>php code<\/font><\/td><\/tr><tr><td.*? class="code"><pre.*?><code>\s*([\s\S]*?)\s*<\/code><\/pre><\/td><\/tr><\/table>(<!-- endphpcode \d+ -->)?/gi,
        replacement: "[php]\n$1\n[/php]"
    },
    {
        name: "New lines",
    ...
    {
        name: "Wiki Header 1",
        regexp: /<h1 class="mw_heading">([\s\S]*?)<!-- mw_heading --><\/h1>/gi,
        replacement: "=$1="
    },
    {
        name: "Wiki Header 2",
        regexp: /<h2 class="mw_heading">([\s\S]*?)<!-- mw_heading --><\/h2>/gi,
        replacement: "==$1=="
    },
    {
        name: "Wiki Header 3",
        regexp: /<h3 class="mw_heading">([\s\S]*?)<!-- mw_heading --><\/h3>/gi,
        replacement: "===$1==="
    },
    {
        name: "Wiki Header 4",
        regexp: /<h4 class="mw_heading">([\s\S]*?)<!-- mw_heading --><\/h4>/gi,
        replacement: "====$1===="
    },
    {
        name: "Wiki Header 5",
        regexp: /<h5 class="mw_heading">([\s\S]*?)<!-- mw_heading --><\/h5>/gi,
        replacement: "=====$1====="
    },
    {
        name: "Anchor link",
        regexp: /<a href="#(.*?)">([\s\S]*?)<\/a>/gi,
        replacement: "[[#$1|$2]]"
    },
    {
        name: "Anchor",
        regexp: /<a name="(.*?)" id="\1"><\/a>/gi,
        replacement: "[[#$1]]"
    },
    {
        name: "Link cleanup",
        regexp: /<a href="\/members\/([^\/]*)(?:\+|%20)([^\/]*?)\/" target="_blank">([^<]*?)<\/a>/gi,
        replacement: '<a href="/members/$1 $2/" target="_blank">$3</a>',
        repeatTillMatchless: true
    },
    {
        name: "Member tag",
        regexp: /<a href="\/members\/([^\/]*?)\/" target="_blank">\1<\/a>/gi,
        replacement: "[[member:$1]]"
    },
    {
        name: "Member with alias tag",
        regexp: /<a href="\/members\/([^\/]*?)\/" target="_blank">([^<]*?)<\/a>/gi,
        replacement: "[[member:$1|$2]]"
    },
    {
        name: "Link space cleanup for PM tags",
        regexp: /(<a href="\/forums\/index.php\?fn=send_pm(?:_thread)?\&amp;manual_username=)([^"]*?)(?:\+|%20)([^"]*?)(\&amp;title=[^"]*?)?" target="_blank">([^<]*?)<\/a>/gi,
        replacement: '$1$2 $3$4" target="_blank">$5</a>',
        repeatTillMatchless: true
    },
    {
        name: "PM tags with subject lines",
        regexp: /<a href="\/forums\/index.php\?fn=send_pm(?:_thread)?\&amp;manual_username=([^"]*?)\&amp;title=([^"]*?)" target="_blank">\1<\/a>/gi,
        replacement: "[[pm:$1|subject:$2]]"
    },
    {
        name: "PM tags with subject lines, whose link name does not match the recipient name",
        regexp: /<a href="\/forums\/index.php\?fn=send_pm(?:_thread)?\&amp;manual_username=([^"]*?)\&amp;title=([^"]*?)" target="_blank">([^<]*?)<\/a>/gi,
        replacement: "[[pm:$1|subject:$2|$3]]"
    },
    {
        name: "PM tags without subject lines",
        regexp: /<a href="\/forums\/index.php\?fn=send_pm(?:_thread)?\&amp;manual_username=([^"]*?)" target="_blank">\1<\/a>/gi,
        replacement: "[[pm:$1]]"
    },
    {
        name: "PM tags without subject lines, whose link name does not match the recipient name",
        regexp: /<a href="\/forums\/index.php\?fn=send_pm(?:_thread)?\&amp;manual_username=([^"]*?)" target="_blank">([^<]*?)<\/a>/gi,
        replacement: "[[pm:$1|$2]]"
    },
    {
        name: "Old spoilers",
        regexp: /<div class="spoiler_header"><b>Spoiler:<\/b> <span class="spoilertitle">(.*?)<\/span><\/div><div class="spoiler"><div><span class="tip">Highlight this box with your cursor to read the spoiler text.<\/span><hr>([\s\S]*?)<\/div><\/div>/gi,
    ...
    },
    {
        ...
        regexp: /<(\/)?(b|i|u|sup|sub|pre|[ou]l)>/gi,
        replacement: "[$1$2]"
    },
    {
    ...
    {
        name: "HTML5 yt tags",
        regexp: /<!-- yt --><iframe[^>]*?src="https:\/\/www.youtube.com\/embed\/(.*?)\?wmode=transparent".*?><\/iframe><!-- \/yt -->/g,
        replacement: "[yt]$1[/yt]"
    },
    {
        name: "HTML5 youtube tags",
        regexp: /<iframe[^>]*?src="https:\/\/www.youtube.com\/embed\/(.*?)\?wmode=transparent".*?><\/iframe>/g,
        replacement: "[youtube]$1[/youtube]"
    },
    {
        name: "Embedded youtube videos",
        regexp: /<object.*?>.*?value="http:\/\/www.youtube.com\/v\/(.*?)">.*?<\/object>/g,
        replacement: "[youtube]$1[/youtube]"
    },
    {
        name: "Color",
        regexp: /<span style="color:\s*(\S*?);">/g,
        replacement: "[color=$1]"
    },
    {
        name: "End color",
    ...
    {
        name: "Image links",
        regexp: /<a href="(.*?)".*?><img src="(.*?)" border="1".*? \/><\/a>/gi,
    ...
    },
    {
        ...
        argument: {
            regexp: /<img src="http:\/\/staticneo.com\/neoassets\/smileys\/([^.]*?)\.(?:gif|png)"[^>]*?vspace[^>]*?>/gi,
            smileyMap: {
                animangry: ':angry:',
                thicksmile: ':thick:',
    ...
    {
        name: "faqimg tag",
        regexp: /<a href="http:\/\/img.neoseeker.com\/v_vfaq_image\.php\?id=(\d+)" class="faqimage"><img src="(.*?)" \/><\/a>/gi,
    ...
    },
    {
        ...
        regexp: /<a href="http:\/\/www.neoseeker.com\/members\/[^\/]*?\/" class="mention">(\S*?)<\/a>/g,
        replacement: "@$1"
    },
    {
        ...
        // The real HTML doesn't have the host name in the URL,
        // but the earlier "Internal link cleansing rule" changes that.
        regexp: /<a href="http:\/\/www.neoseeker.com\/members\/[^\/]*?\/" class="mention">([\s\S]*?)<\/a>/g,
        replacement: "@$1@"
    },
    {
        name: "Wiki-style links",
        regexp: /<a href="([^"]*?)" target="_blank"[^>]*?class="wikianchor">(.*?)<\/a>/gi,
        replacement: "[$1 $2]"
    },
    {
        name: "Links without names",
        regexp: /<a href="([^"]*?)"[^>]*?>\1<\/a>/gi,
        replacement: "$1"
    },
    {
    ...
    {
        name: "Float tags",
        regexp: /<div style="float:\s?(.*?)">([\s\S]*?)<\/div><!-- float:\1 -->/g,
    ...
    },
    {
        ...
        regexp: /<object.*?id="gtembed".*?>[\s\S]*?http:\/\/www.gametrailers.com\/remote_wrap.php\?mid=(\d+)[\s\S]*?<\/object>/g,
        replacement: "[gametrailers]$1[/gametrailers]"
    },
    {
        name: "Gametrailers user video tag",
        regexp: /<object.*?id="gtembed".*?>[\s\S]*?http:\/\/www.gametrailers.com\/remote_wrap.php\?umid=(\d+)[\s\S]*?<\/object>/g,
        replacement: "[gametrailers_uservideo]$1[/gametrailers_uservideo]"
    },
    {
        name: "Gamevideos tag",
        regexp: /<object.*?id="gamevideos6".*?>[\s\S]*?http:\/\/www.gamevideos.com\:80\/swf\/gamevideos11.swf\?embedded=1&fullscreen=1&autoplay=0&src=http:\/\/www.gamevideos.com:80\/video\/videoListXML%3Fid%3D(\d+)%26ordinal%3D1176581224863%26adPlay%3Dfalse[\s\S]*?<\/object>/g,
        replacement: "[gamevideos]$1[/gamevideos]"
    },
    {
        name: "IGN video",
        regexp: /<embed[^>]*?flashvars='([^']*?ign.com[^']*?)&allownetworking.*?'><\/embed>/g,
        replacement: "[ignvideo]$1[/ignvideo]"
    },
    {
        name: "Neo videos",
        regexp: /<object.*?width="470".*?>\r?\n?<param name="movie" value="http:\/\/videos.neoseeker.com\/v\/(.*?)" \/>[\s\S]*?<\/object>/gi,
    ...
    {
        regexp: /<embed id="mymovie".*?flashvars=".*?paramsURI=[^"]*?id%3D(\d+)[^"]*?".*?>/g,
